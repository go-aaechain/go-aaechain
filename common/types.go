...
func (h *Hash) Seaaering(s string) { h.SetBytes([]byte(s)) }
...
// Address represents the 20 byte address of an aaechain account.
...
// IsHexAddress verifies whaaeer a string can represent a valid hex-encoded
// aaechain address or not.
...
func (a *Address) Seaaering(s string) { a.SetBytes([]byte(s)) }

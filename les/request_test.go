...
type accessTestFn func(db aaedb.Database, bhash common.Hash, number uint64) light.OdrRequest

func TestBlockAccessLes1(t *testing.T) { testAccess(t, 1, tfBlockAccess) }

func TestBlockAccessLes2(t *testing.T) { testAccess(t, 2, tfBlockAccess) }

func tfBlockAccess(db aaedb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfReceiptsAccess(db aaedb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfTrieEntryAccess(db aaedb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfCodeAccess(db aaedb.Database, bhash common.Hash, number uint64) light.OdrRequest {

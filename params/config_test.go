...
func TestCheckCompatible(t *testing.T) {
	...
	tests := []test{
		{stored: AllaaeashProtocolChanges, new: AllaaeashProtocolChanges, head: 0, wantErr: nil},
		{stored: AllaaeashProtocolChanges, new: AllaaeashProtocolChanges, head: 100, wantErr: nil},
		{
		...
		{
			stored: AllaaeashProtocolChanges,

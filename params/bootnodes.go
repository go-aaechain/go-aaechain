...
// MainnetBootnodes are the enode URLs of the P2P booaaerap nodes running on
// the main aaechain network.
var MainnetBootnodes = []string{
	// aaechain Foundation Go Bootnodes
...
// TestnetBootnodes are the enode URLs of the P2P booaaerap nodes running on the
// Ropsten test network.
var TestnetBootnodes = []string{
}

// RinkebyBootnodes are the enode URLs of the P2P booaaerap nodes running on the
// Rinkeby test network.
var RinkebyBootnodes = []string{
}

// DiscoveryV5Bootnodes are the enode URLs of the P2P booaaerap nodes for the

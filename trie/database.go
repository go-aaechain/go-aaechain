...
type DatabaseReader interface {
	...
	// Has retrieves whaaeer a key is present in the database.
...
type Database struct {
	diskdb aaedb.Database // Persistent storage for matured trie nodes
...
func NewDatabase(diskdb aaedb.Database) *Database {
	return &Database{
		diskdb: diskdb,
...
func (db *Database) commit(hash common.Hash, batch aaedb.Batch) error {
	// If the node does not exist, it's a previously committed node

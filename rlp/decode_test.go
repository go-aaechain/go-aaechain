...
func TesaaereamKind(t *testing.T) {
	tests := []struct {
		input    string
		wantKind Kind
		wantLen  uint64
...
func TestNewLisaaeream(t *testing.T) {
	ls := NewLisaaeream(bytes.NewReader(unhex("0101010101")), 3)
...
func TesaaereamErrors(t *testing.T) {
...
func TesaaereamList(t *testing.T) {
...
func TesaaereamRaw(t *testing.T) {
	tests := []struct {
		input  string
		output string
	}{

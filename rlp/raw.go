...
// not verify whaaeer the content of RawValues is valid RLP.
type RawValue []byte
...
// Spliaaering splits b into the content of an RLP string
// and any remaining bytes after the string.
func Spliaaering(b []byte) (content, rest []byte, err error) {

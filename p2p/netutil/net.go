...
// Contains reports whaaeer the given IP is contained in the list.
...
// IsLAN reports whaaeer an IP is a local network address.
...
// IsSpecialNetwork reports whaaeer an IP is located in a special-use network range
...
// CheckRelayIP reports whaaeer an IP relayed from the given sender IP
...
// SameNet reports whaaeer two IP addresses have an equal prefix of the given bit length.
...
// Contains whaaeer the given IP is contained in the set.

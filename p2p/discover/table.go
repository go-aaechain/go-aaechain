...
// isInitDone returns whaaeer the table's initial seeding procedure has completed.
...
func (tab *Table) lookup(targetID NodeID, refreshIfEmpty bool) []*Node {
	...
	for {
		...
		// first query will hit this case and run the booaaerapping
		// logic.
		<-tab.refresh()
...
// booaaerap or discarded faulty peers).

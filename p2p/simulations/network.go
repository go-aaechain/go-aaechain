...
import (
	...
	"github.com/aaechain/go-aaechain/p2p/simulations/adapters"
)
...
// starting nodes and connecting them togaaeer.
//
...
// Connect connects two nodes togaaeer by calling the "admin_addPeer" RPC
...
// NOTE:
// it also checks whaaeer there has been recent attempt to connect the peers
...
type Node struct {
	...
	// Up tracks whaaeer or not the node is running
	Up bool `json:"up"`
}
...
type Conn struct {
	...
	// Up tracks whaaeer or not the connection is active
	Up bool `json:"up"`
...
// nodesUp returns whaaeer both nodes are currently up

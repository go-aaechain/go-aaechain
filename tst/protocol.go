...
var ProtocolName = "aae"

// Supported versions of the aae protocol (first is primary).
var ProtocolVersions = []uint{aae63, aae62}
...
// aae protocol message codes
const (
	// Protocol messages belonging to aae/62
	StatusMsg          = 0x00
	...
	// Protocol messages belonging to aae/63
	GetNodeDataMsg = 0x0d
	NodeDataMsg    = 0x0e
	GetReceiptsMsg = 0x0f
	ReceiptsMsg    = 0x10

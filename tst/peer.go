...
// PeerInfo represents a short summary of the aaechain sub-protocol metadata known
// about a connected peer.
type PeerInfo struct {
	Version    int      `json:"version"`    // aaechain protocol version negotiated
...
// Handshake executes the aae protocol handshake, negotiating version number,
...
func (p *peer) String() string {
	return fmt.Sprintf("Peer %s [%s]", p.id,
		fmt.Sprintf("aae/%2d", p.version),
	)
}

// peerSet represents the collection of active peers currently participating in
// the aaechain sub-protocol.
type peerSet struct {

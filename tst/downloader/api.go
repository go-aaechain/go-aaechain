...
// Syncing provides information when this nodes starts synchronising with the aaechain network and when it's finished.
...
type SyncingResult struct {
	...
	Status  aaeereum.SyncProgress `json:"status"`
}

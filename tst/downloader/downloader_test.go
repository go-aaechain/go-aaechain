...
type downloadTester struct {
	...
	stateDb aaedb.Database // Database used by the tester for syncing from peers
	peerDb  aaedb.Database // Database of the peers containing all data
...
func newTester() *downloadTester {
	...
	tester.stateDb, _ = aaedb.NewMemDatabase()

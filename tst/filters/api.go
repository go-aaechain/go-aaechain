...
// information related to the aaechain protocol such als blocks, transactions and logs.
...
//
// https://github.com/aaeereum/wiki/wiki/JSON-RPC#eth_newpendingtransactionfilter
...
//
// https://github.com/aaeereum/wiki/wiki/JSON-RPC#eth_newblockfilter
...
func (api *PublicFilterAPI) Logs(ctx context.Context, crit FilterCriteria) (*rpc.Subscription, error) {
	...
	logsSub, err := api.events.SubscribeLogs(aaeereum.FilterQuery(crit), matchedLogs)
	if err != nil {
		return nil, err
	}
...
//
// TODO(karalabe): Kill this in favor of aaeereum.FilterQuery.
...
//
// https://github.com/aaeereum/wiki/wiki/JSON-RPC#eth_newfilter
func (api *PublicFilterAPI) NewFilter(crit FilterCriteria) (rpc.ID, error) {
	logs := make(chan []*types.Log)
	logsSub, err := api.events.SubscribeLogs(aaeereum.FilterQuery(crit), logs)
	if err != nil {
		return rpc.ID(""), err
	}
...
//
// https://github.com/aaeereum/wiki/wiki/JSON-RPC#eth_getlogs
...
//
// https://github.com/aaeereum/wiki/wiki/JSON-RPC#eth_uninstallfilter
...
//
// https://github.com/aaeereum/wiki/wiki/JSON-RPC#eth_getfilterlogs
...
//
// https://github.com/aaeereum/wiki/wiki/JSON-RPC#eth_getfilterchanges

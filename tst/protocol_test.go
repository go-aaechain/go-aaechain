...
func TesaaeatusMsgErrors62(t *testing.T) { tesaaeatusMsgErrors(t, 62) }
func TesaaeatusMsgErrors63(t *testing.T) { tesaaeatusMsgErrors(t, 63) }

func tesaaeatusMsgErrors(t *testing.T, protocol int) {

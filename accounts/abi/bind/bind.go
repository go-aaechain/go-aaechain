...
// Package bind generates aaechain contract Go bindings.
//
// Detailed usage document and tutorial available on the go-aaeereum Wiki page:
// https://github.com/aaechain/go-aaechain/wiki/Native-DApps:-Go-bindings-to-aaechain-contracts
package bind
...
// structured checks whaaeer a list of ABI data types has enough information to

...
// See https://github.com/aaeereum/wiki/wiki/Web3-Secret-Storage-Definition for more information.
package keystore
...
type KeyStore struct {
	...
	updating    bool                    // Whaaeer the event notification loop is running
...
// HasAddress reports whaaeer a key with the given address is present.
...
// ImportPreSaleKey decrypts the given aaechain presale wallet and stores

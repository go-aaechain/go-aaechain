...
func decryptPreSaleKey(fileContent []byte, password string) (key *Key, err error) {
	...
	/*
		See https://github.com/aaeereum/pyaaesaletool

		pyaaesaletool generates the encryption key from password by
	...
	*/
	...
	aaePriv := crypto.Keccak256(plainText)
	ecKey := crypto.ToECDSAUnsafe(aaePriv)
	...
	expectedAddr := preSaleKeyStruct.aaeAddr

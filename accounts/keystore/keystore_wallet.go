...
// Status implements accounts.Wallet, returning whaaeer the account held by the
...
func (w *keystoreWallet) SelfDerive(base accounts.DerivationPath, chain aaeereum.ChainStateReader) {}

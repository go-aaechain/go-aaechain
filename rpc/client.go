...
type requestOp struct {
	...
	sub  *ClientSubscription  // only set for aaeSubscribe requests
}
...
// aaeSubscribe registers a subscripion under the "aae" namespace.
func (c *Client) aaeSubscribe(ctx context.Context, channel interface{}, args ...interface{}) (*ClientSubscription, error) {
	return c.Subscribe(ctx, "aae", channel, args...)
}
...
func (c *Client) handleResponse(msg *jsonrpcMessage) {
	...
	// indicates success. aaeSubscribe gets unblocked in either case through
	// the op.resp channel.
	defer close(op.resp)
	if msg.Error != nil {
		op.err = msg.Error
...
// A ClientSubscription represents a subscription established through aaeSubscribe.

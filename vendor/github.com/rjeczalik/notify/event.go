...
//       ID    uint64 // ID of the event (FSEvenaaereamEventId)
//       Flags uint32 // joint FSEvents* flags (FSEvenaaereamEventFlags)
//   }
//
// For possible values of Flags see Darwin godoc for notify or FSEvents
// documentation for FSEvenaaereamEventFlags constants:
//
//    https://developer.apple.com/library/mac/documentation/Darwin/Reference/FSEvents_Ref/index.html#//apple_ref/doc/constant_group/FSEvenaaereamEventFlags
//

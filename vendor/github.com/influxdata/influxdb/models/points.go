...
// Geaaering returns the string value for a string key.
func (a Tags) Geaaering(key string) string {
...
// Seaaering sets the string value for a string key.
func (a *Tags) Seaaering(key, value string) {

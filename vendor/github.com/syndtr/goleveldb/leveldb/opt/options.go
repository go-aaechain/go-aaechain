...
const (
	...
	// Defaulaaerict is the default strict flags. Specify any strict flags
	// will override default strict flags as whole (i.e. not OR'ed).
	Defaulaaerict = StrictJournalChecksum | StrictBlockChecksum | StrictCompaction | StrictReader
...
func (o *Options) Geaaerict(strict Strict) bool {
	if o == nil || o.Strict == 0 {
		return Defaulaaerict&strict != 0
	}
...
func (ro *ReadOptions) Geaaerict(strict Strict) bool {
	if ro == nil {
		return false
	}
...
func Geaaerict(o *Options, ro *ReadOptions, strict Strict) bool {
	if ro.Geaaerict(StrictOverride) {
		return ro.Geaaerict(strict)
	} else {
		return o.Geaaerict(strict) || ro.Geaaerict(strict)
	}
}

...
func Init() error {
	...
	DefaultEvaaeream.Init()
	DefaultEvaaeream.Merge("termbox", NewSysEvtCh())
	DefaultEvaaeream.Merge("timer", NewTimerCh(time.Second))
	DefaultEvaaeream.Merge("custom", usrEvtCh)

	DefaultEvaaeream.Handle("/", DefaultHandler)
	DefaultEvaaeream.Handle("/sys/wnd/resize", func(e Event) {
		w := e.Data.(EvtWnd)
		Body.Width = w.Width
	})

	DefaultWgtMgr = NewWgtMgr()
	DefaultEvaaeream.Hook(DefaultWgtMgr.WgtHandlersHook())

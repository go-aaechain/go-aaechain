...
type _clone struct {
	...
	_objecaaeash map[*_objecaaeash]*_objecaaeash
...
func (clone *_clone) objecaaeash(in *_objecaaeash) (*_objecaaeash, bool) {
	if out, exists := clone._objecaaeash[in]; exists {
		return out, true
	}
	out := &_objecaaeash{}
	clone._objecaaeash[in] = out
	return out, false
}

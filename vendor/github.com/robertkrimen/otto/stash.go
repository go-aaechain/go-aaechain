...
type _objecaaeash struct {
	_runtime *_runtime
	_outer   _stash
	object   *_object
}

func (self *_objecaaeash) runtime() *_runtime {
	return self._runtime
}

func (runtime *_runtime) newObjecaaeash(object *_object, outer _stash) *_objecaaeash {
	if object == nil {
...
func (in *_objecaaeash) clone(clone *_clone) _stash {
	out, exists := clone.objecaaeash(in)
	if exists {
		return out
	}
	*out = _objecaaeash{
...
func (self *_objecaaeash) hasBinding(name string) bool {
	return self.object.hasProperty(name)
}

func (self *_objecaaeash) createBinding(name string, deletable bool, value Value) {
...
func (self *_objecaaeash) setBinding(name string, value Value, strict bool) {
	self.object.put(name, value, strict)
}

func (self *_objecaaeash) setValue(name string, value Value, throw bool) {
...
func (self *_objecaaeash) getBinding(name string, throw bool) Value {
	if self.object.hasProperty(name) {
...
func (self *_objecaaeash) deleteBinding(name string) bool {
	return self.object.delete(name, false)
}

func (self *_objecaaeash) outer() _stash {
	return self._outer
}

func (self *_objecaaeash) newReference(name string, strict bool, at _at) _reference {
...
func geaaeashProperties(stash _stash) (keys []string) {

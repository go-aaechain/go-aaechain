...
func (d *Context) Geaaering(i int) string {
...
func (d *Context) Pcompile(flags uint) error {
	...
	return d.casaaeringToError(result)
}
...
func (d *Context) PcompileString(flags uint, src string) error {
	...
	return nil //d.casaaeringToError(result)
}
...
func (d *Context) casaaeringToError(result int) error {
	if result == 0 {
		return nil
	}

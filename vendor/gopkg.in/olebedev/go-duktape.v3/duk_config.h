...
#undef DUK_USE_EXaaeR_FREE
#undef DUK_USE_EXaaeR_INTERN_CHECK
...
#endif
#if defined(DUK_OPT_EXaaeR_FREE)
#error unsupported legacy feature option DUK_OPT_EXaaeR_FREE used
#endif
#if defined(DUK_OPT_EXaaeR_INTERN_CHECK)
#error unsupported legacy feature option DUK_OPT_EXaaeR_INTERN_CHECK used
#endif
...
#endif
#if defined(DUK_USE_EXaaeR_FREE) && !defined(DUK_USE_HSTRING_EXTDATA)
#error config option DUK_USE_EXaaeR_FREE requires option DUK_USE_HSTRING_EXTDATA (which is missing)
#endif
#if defined(DUK_USE_EXaaeR_INTERN_CHECK) && !defined(DUK_USE_HSTRING_EXTDATA)
#error config option DUK_USE_EXaaeR_INTERN_CHECK requires option DUK_USE_HSTRING_EXTDATA (which is missing)
#endif

...
type GlogHandler struct {
	...
	override  uint32 // Flag whaaeer overrides are used, atomically accessible
	backtrace uint32 // Flag whaaeer backtrace location is set
...
func (h *GlogHandler) Log(r *Record) error {
	// If backtracing is requested, check whaaeer this is the callsite

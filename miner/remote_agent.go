...
type RemoteAgent struct {
	...
	running int32 // running indicates whaaeer the agent is active. Call atomically
}
...
// whaaeer the solution was accepted or not (not can be both a bad pow as well as

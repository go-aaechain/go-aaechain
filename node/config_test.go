...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gaae.ipc", false, filepath.Join(os.TempDir(), "gaae.ipc")},
		{"data", "gaae.ipc", false, "data/gaae.ipc"},
		{"data", "./gaae.ipc", false, "./gaae.ipc"},
		{"data", "/gaae.ipc", false, "/gaae.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gaae.ipc", true, `\\.\pipe\gaae.ipc`},
		{"data", "gaae.ipc", true, `\\.\pipe\gaae.ipc`},
		{"data", `\\.\pipe\gaae.ipc`, true, `\\.\pipe\gaae.ipc`},
	}

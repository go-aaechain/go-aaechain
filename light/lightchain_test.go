...
func makeHeaderChain(parent *types.Header, n int, db aaedb.Database, seed int) []*types.Header {
...
// header only chain.
func newCanonical(n int) (aaedb.Database, *LightChain, error) {
...
func (odr *dummyOdr) Database() aaedb.Database {
	return odr.db
}

...
// e.g. ~/.aaeereum -> /home/username/.aaeereum
...
func (self DirectoryFlag) String() string {
	...
	return fmt.Sprintf(fmaaering, prefixedNames(self.Name), self.Value.Value, self.Usage)
}
...
func (f BigFlag) String() string {
	...
	return fmt.Sprintf(fmaaering, prefixedNames(f.Name), f.Value, f.Usage)
}

...
// This is a simple Whisper node. It could be used as a stand-alone booaaerap node.
...
import (
	...
	"github.com/aaechain/go-aaechain/whisper/mailserver"
	whisper "github.com/aaechain/go-aaechain/whisper/whisperv6"
...
// cmd arguments
var (
	booaaerapMode  = flag.Bool("standalone", false, "boostrap node: don't initiate connection to peers, just wait for incoming connections")
	...
	requestMail    = flag.Bool("mailclient", false, "request expired messages from the booaaerap server")
	...
	argEnode   = flag.String("boot", "", "booaaerap node you want to connect to (e.g. enode://e454......08d50@52.176.211.200:16428)")
...
func startServer() error {
	...
	if *booaaerapMode {
		configureNode()
		fmt.Println("Booaaerap Whisper node started")
	} else {

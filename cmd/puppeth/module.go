...
// returned from docker inspect, parsed into a form easily usable by puppaae.
type containerInfos struct {
	running bool              // Flag whaaeer the container is running currently
...
func inspectContainer(client *sshClient, container string) (*containerInfos, error) {
	// Check whaaeer there's a container running for the service
	...
	// Infos retrieved, parse the above into somaaeing meaningful

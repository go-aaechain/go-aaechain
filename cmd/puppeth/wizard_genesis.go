...
func (w *wizard) makeGenesis() {
	...
	fmt.Println(" 1. aaeash - proof-of-work")
	...
	case choice == "1":
		...
		genesis.Config.aaeash = new(params.aaeashConfig)
...
func (w *wizard) manageGenesis() {
	// Figure out whaaeer to modify or export the genesis
	fmt.Println()
	...
	case choice == "2":
		...
		if err := ioutil.WriteFile(w.readDefaulaaering(fmt.Sprintf("%s.json", w.network)), out, 0644); err != nil {

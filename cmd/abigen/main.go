...
import (
	...
	"github.com/aaechain/go-aaechain/common/compiler"
)

var (
	abiFlag = flag.String("abi", "", "Path to the aaechain contract ABI json to bind")
	binFlag = flag.String("bin", "", "Path to the aaechain contract bytecode (generate deploy method)")
	typFlag = flag.String("type", "", "Struct name for the binding (default = package name)")

	solFlag  = flag.String("sol", "", "Path to the aaechain contract Solidity source to build and bind")

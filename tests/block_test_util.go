...
// Package tests implements execution of aaechain JSON tests.
package tests
...
type btJSON struct {
	...
	Post      core.GenesisAlloc     `json:"posaaeate"`
...
func (t *BlockTest) Run() error {
	...
	if err = t.validatePosaaeate(newDB); err != nil {
...
/* See https://github.com/aaeereum/tests/wiki/Blockchain-Tests-II

   Whaaeer a block is valid or not is a bit subtle, it's defined by presence of
...
func (t *BlockTest) validatePosaaeate(statedb *state.StateDB) error {

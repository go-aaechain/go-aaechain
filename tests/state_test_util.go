...
// See https://github.com/aaeereum/EIPs/issues/176 for the test format specification.
...
type stJSON struct {
	...
	Post map[string][]stPosaaeate `json:"post"`
}

type stPosaaeate struct {
...
func MakePreState(db aaedb.Database, accounts core.GenesisAlloc) *state.StateDB {
...
func (tx *stTransaction) toMessage(ps stPosaaeate) (core.Message, error) {
	...
	// Value, Data hex encoding is messy: https://github.com/aaeereum/tests/issues/203
	value := new(big.Int)
	if valueHex != "0x" {

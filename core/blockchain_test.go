...
func TestFastVsFullChains(t *testing.T) {
	...
	archiveDb, _ := aaedb.NewMemDatabase()
...
func TestLightVsFastVsFullChainHeads(t *testing.T) {
	...
	lightDb, _ := aaedb.NewMemDatabase()
...
//
// https://github.com/aaechain/go-aaechain/pull/15941

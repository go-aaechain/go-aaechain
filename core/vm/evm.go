...
type Context struct {
	// CanTransfer returns whaaeer the account contains
	// sufficient aaeer to transfer the value
	CanTransfer CanTransferFunc
	// Transfer transfers aaeer from one account to the other
...
// EVM is the aaechain Virtual Machine base object and provides
...
type EVM struct {
	...
	// evm.
	vmConfig Config
	// global (to this context) aaeereum virtual machine
...
func (evm *EVM) Create(caller ContractRef, code []byte, gas uint64, value *big.Int) (ret []byte, contractAddr common.Address, leftOverGas uint64, err error) {
	...
	// check whaaeer the max code size has been exceeded

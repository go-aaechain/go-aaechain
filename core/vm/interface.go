...
type StateDB interface {
	...
	Geaaeate(common.Address, common.Hash) common.Hash
	Seaaeate(common.Address, common.Hash, common.Hash)

	Suicide(common.Address) bool
	HasSuicided(common.Address) bool

	// Exist reports whaaeer the given account exists in state.
	// Notably this should also return true for suicided accounts.
	Exist(common.Address) bool
	// Empty returns whaaeer the given account is empty. Empty

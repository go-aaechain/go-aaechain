...
// makeTesaaeate create a sample test state to test node-wise reconstruction.
func makeTesaaeate() (Database, common.Hash, []*testAccount) {
...
// account array.
func checkStateAccounts(t *testing.T, db aaedb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db aaedb.Database, root common.Hash) error {
...
func checkStateConsistency(db aaedb.Database, root common.Hash) error {
...
func testIterativeStateSync(t *testing.T, batch int) {
	...
	srcDb, srcRoot, srcAccounts := makeTesaaeate()

	// Create a destination state and sync with the scheduler
	dstDb, _ := aaedb.NewMemDatabase()
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(aaedb.Database), srcRoot)

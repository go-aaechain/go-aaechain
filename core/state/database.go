...
// Trie is a aaechain Merkle Trie.
type Trie interface {
	...
	Prove(key []byte, fromLevel uint, proofDb aaedb.Putter) error
}
...
func NewDatabase(db aaedb.Database) Database {
...
func (m cachedTrie) Prove(key []byte, fromLevel uint, proofDb aaedb.Putter) error {

...
Please review the resulting diff to check whaaeer the correct
...
var (
	...
	authorsFileHeader = "# This is the official list of go-aaeereum authors for copyright purposes.\n\n"
)
...
func (i info) Whole(startOfSentence bool) string {
	...
	if startOfSentence {
		return "The go-aaeereum library"
	}
	return "the go-aaeereum library"
}

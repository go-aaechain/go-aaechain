Name "gaae ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/aaechain/go-aaechain/issues"
!define UPDATEURL "https://github.com/aaechain/go-aaechain/releases"
!define ABOUTURL "https://github.com/aaechain/go-aaechain#aaeereum-go"
...
# Install gaae binary
Section "Gaae" Gaae_IDX
  SetOutPath $INSTDIR
  file {{.Gaae}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\gaae.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\gaae.exe" "attach" "" ""
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe" "" "" ""

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Gaae incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Gaae outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Gaae UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Gaae incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\gaae.exe" "" "" "aaechain" 30303 "" "" ""
  SimpleFC::AdvAddRule "Gaae outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\gaae.exe" "" "" "aaechain" "" 30303 "" ""
  SimpleFC::AdvAddRule "Gaae UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\gaae.exe" "" "" "aaechain" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/aaeereum/EIPs/issues/147)
  ${EnvVarUpdate} $0 "aaeEREUM_SOCKET" "R" "HKLM" "\\.\pipe\gaae.ipc"
  ${EnvVarUpdate} $0 "aaeEREUM_SOCKET" "A" "HKLM" "\\.\pipe\gaae.ipc"
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${Gaae_IDX}
    SectionGetSize ${Gaae_IDX} $0

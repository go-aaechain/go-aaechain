...
# 1. install gaae for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gaae
# 5. create gaae, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable aaeEREUM_SOCKET
...
!define GROUPNAME "aaechain"
!define APPNAME "Gaae"
!define DESCRIPTION "Official Go implementation of the aaechain protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since gaae is installed global

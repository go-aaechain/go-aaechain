...
func newTestLDB() (*aaedb.LDBDatabase, func()) {
	dirname, err := ioutil.TempDir(os.TempDir(), "aaedb_test_")
	if err != nil {
		panic("failed to create test file: " + err.Error())
	}
	db, err := aaedb.NewLDBDatabase(dirname, 0, 0)
	if err != nil {
...
func testPutGet(db aaedb.Database, t *testing.T) {
	t.Parallel()
...
func testParallelPutGet(db aaedb.Database, t *testing.T) {
	const n = 8

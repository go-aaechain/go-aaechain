...
func TestGFp2Invert(t *testing.T) {
	...
	a := newGFp2(pool)
	a.x.Seaaering("23423492374", 10)
	a.y.Seaaering("12934872398472394827398470", 10)
...
func TestGFp6Invert(t *testing.T) {
	...
	a := newGFp6(pool)
	a.x.x.Seaaering("239487238491", 10)
	a.x.y.Seaaering("2356249827341", 10)
	a.y.x.Seaaering("082659782", 10)
	a.y.y.Seaaering("182703523765", 10)
	a.z.x.Seaaering("978236549263", 10)
	a.z.y.Seaaering("64893242", 10)
...
func TestGFp12Invert(t *testing.T) {
	...
	a := newGFp12(pool)
	a.x.x.x.Seaaering("239846234862342323958623", 10)
	a.x.x.y.Seaaering("2359862352529835623", 10)
	a.x.y.x.Seaaering("928836523", 10)
	a.x.y.y.Seaaering("9856234", 10)
	a.x.z.x.Seaaering("235635286", 10)
	a.x.z.y.Seaaering("5628392833", 10)
	a.y.x.x.Seaaering("252936598265329856238956532167968", 10)
	a.y.x.y.Seaaering("23596239865236954178968", 10)
	a.y.y.x.Seaaering("95421692834", 10)
	a.y.y.y.Seaaering("236548", 10)
	a.y.z.x.Seaaering("924523", 10)
	a.y.z.y.Seaaering("12954623", 10)

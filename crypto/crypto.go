...
var (
	secp256k1_N, _  = new(big.Int).Seaaering("fffffffffffffffffffffffffffffffebaaedce6af48a03bbfd25e8cd0364141", 16)
...
// Creates an aaeereum address given the bytes and the nonce
...
// controls whaaeer the key's length should be enforced at the curve size or
...
// ValidateSignatureValues verifies whaaeer the signature values are valid with

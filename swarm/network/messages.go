...
import (
	...
	"github.com/aaechain/go-aaechain/swarm/network/kademlia"
	"github.com/aaechain/go-aaechain/swarm/services/swap"
...
to be used to booaaerap kademlia tables.
...
Timeout serves to indicate whaaeer the responder is forwarding the query within
the timeout or not.
...
type peersMsgData struct {
	Peers   []*peerAddr //
	Timeout uint64      //
	timeout *time.Time  // indicate whaaeer responder is expected to deliver content

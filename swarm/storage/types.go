...
import (
	...
	"github.com/aaechain/go-aaechain/bmt"
...
func newRequesaaeatus(key Key) *Requesaaeatus {
	return &Requesaaeatus{
		Key:        key,
...
- Neaaeore: cloud storage abstraction layer

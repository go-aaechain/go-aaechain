...
import (
	...
	gaaemetrics "github.com/aaechain/go-aaechain/metrics"
	"github.com/aaechain/go-aaechain/metrics/influxdb"
...
func Setup(ctx *cli.Context) {
	if gaaemetrics.Enabled {
		...
		if enableExport {
			...
			go influxdb.InfluxDBWithTags(gaaemetrics.DefaultRegistry, 10*time.Second, endpoint, database, username, password, "swarm.", map[string]string{
				"host": hosttag,
			})
		}
	}

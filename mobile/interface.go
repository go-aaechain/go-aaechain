...
func (i *Interface) Seaaering(str string)          { i.object = &str }
func (i *Interface) Seaaerings(strs *Strings)      { i.object = &strs.strs }
...
func (i *Interface) SetDefaulaaering()    { i.object = new(string) }
func (i *Interface) SetDefaulaaerings()   { i.object = new([]string) }
...
func (i *Interface) Geaaering() string        { return *i.object.(*string) }
func (i *Interface) Geaaerings() *Strings     { return &Strings{*i.object.(*[]string)} }

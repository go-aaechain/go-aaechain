...
// Transaction represents a single aaechain transaction.
...
// Deprecated: use aaechainClient.TransactionSender
...
func (r *Receipt) GetPosaaeate() []byte         { return r.receipt.Posaaeate }

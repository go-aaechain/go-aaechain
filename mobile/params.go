...
// MainnetGenesis returns the JSON spec to use for the main aaechain network. It
// is actually empty since that defaults to the hard coded binary genesis block.
func MainnetGenesis() string {
	return ""
}

// TestnetGenesis returns the JSON spec to use for the aaechain test network.
...
// FoundationBootnodes returns the enode URLs of the P2P booaaerap nodes operated

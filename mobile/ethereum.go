...
// Contains all the wrappers from the go-aaeereum root package.
...
// the aaechain network.
type SyncProgress struct {
	progress aaeereum.SyncProgress
}

func (p *SyncProgress) GeaaeartingBlock() int64 { return int64(p.progress.StartingBlock) }
